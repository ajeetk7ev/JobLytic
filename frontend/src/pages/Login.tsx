      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="mt-6">
            ...
            <a
              href={`${import.meta.env.VITE_API_URI}/auth/google`}
              className="mt-6 w-full flex items-center justify-center gap-3 py-3 px-4 bg-secondary/50 hover:bg-secondary border border-border/50 rounded-2xl font-bold transition-all active:scale-[0.98]"
            >
